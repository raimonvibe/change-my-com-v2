...
const billingNavLabel = process.env.NEXT_PUBLIC_PAYMENTS_ENABLED === 'true' ? 'Pricing' : 'Plans'
...
describe('Header Component', () => {
  describe('Desktop View', () => {
    ...
    it('should render all navigation links', () => {
      ...
      const links = ['Home', 'Convert', billingNavLabel, 'Account', 'Contact']
      links.forEach(link => {
...
expect(screen.getByRole('link', { name: /^Convert$/i })).toHaveAttribute('href', '/')
      expect(screen.getByRole('link', { name: new RegExp(`^${billingNavLabel}$`, 'i') })).toHaveAttribute('href', '/billing')
  ...
  describe('Mobile View', () => {
    ...
    it('should toggle mobile menu when button is clicked', () => {
      ...
      const initialLinks = screen.getAllByRole('link', { name: new RegExp(`Home|Convert|${billingNavLabel}|Account|Contact`, 'i') })
      ...
      const linksAfterOpen = screen.getAllByRole('link', { name: new RegExp(`Home|Convert|${billingNavLabel}|Account|Contact`, 'i') })
