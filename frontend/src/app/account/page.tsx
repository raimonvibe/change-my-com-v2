            ...
            {paidCredits > 0 ? (
              ...
              <div className="space-y-4">
                ...
                {PAYMENTS_ENABLED ? (
                  ...
                  <div className="rounded-lg border border-slate-200 bg-slate-50/90 p-4 text-base text-slate-700 leading-relaxed">
                    <p className="font-medium text-slate-900">You&apos;re on the free plan</p>
                    <p className="mt-2">
                      When you use all 20 conversions, your quota <strong className="text-slate-800">resets the next day</strong>. No payment needed.
                    </p>
                    <p className="mt-2 text-sm text-slate-600">
                      See{' '}
                      <Link href="/billing" className="text-sky-700 font-medium underline hover:text-sky-800">
                        Plans &amp; usage
                      </Link>{' '}
                      for details.
                    </p>
